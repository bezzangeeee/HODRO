...
<body id="board_insert">
	...
	<form  id = "frm_insert" name ="frm_insert" action="boardinsertplay.bizpoll" method="POST" enctype="multipart/form-data">
	<div id="b_insert_wrap">
		...
		<div id="insert_fst">
			...
			<div id="insert_title">
				<span>제목</span><input type="text" name ="title"id="input_title">
			</div>
		...
		<div id="insert_scd">
			...
			<div class="insert_textarea"><textarea rows="15" cols="150" id="content" name="content"></textarea></div>
		</div>
		<div id="insert_thr">
			<input type="file" name="uploadfile" id="uploadfile" style="display:none;">
			<input type="button" class="btn btn-file" value="파일선택">
			<span class="file" id="file-name" style="height:29px; border:none;">선택된 파일 없음 </span>
			<i class="fa fa-close" id="close_btn" style="display:none; with:10px;"></i>
		</div>
		<div id="insert_four">
			<button type="submit" id="btn_insert">저장</button>
		</div>
	</div>
	</form>	
		<div class="clr"></div>
